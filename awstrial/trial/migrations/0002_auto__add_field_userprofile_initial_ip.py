...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.initial_ip'
        db.add_column('trial_userprofile', 'initial_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True), keep_default=False)

    
    def backwards(self, orm):
        
        # Deleting field 'UserProfile.initial_ip'
        db.delete_column('trial_userprofile', 'initial_ip')
