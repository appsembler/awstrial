...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GmailAlias'
        db.create_table('trial_gmailalias', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('default_user', self.gf('django.db.models.fields.CharField')(max_length=150)),
        ))
        db.send_create_signal('trial', ['GmailAlias'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'GmailAlias'
        db.delete_table('trial_gmailalias')
    ...
    models = {
        ...
        'trial.gmailalias': {
            'Meta': {'object_name': 'GmailAlias'},
            'default_user': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'trial.instances': {
